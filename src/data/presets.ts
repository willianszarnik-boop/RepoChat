...
export const PRESET_DRIVE_FOLDERS: DriveFolder[] = [
  {
    ...
    url: 'https://drive.google.com/drive/folders/1sgp-example',
    fileCount: 14,
    category: 'SGP',
  },
  {
    ...
    url: 'https://drive.google.com/drive/folders/1hubsoft-example',
    fileCount: 16,
    category: 'HUBSOFT',
  },
  {
    ...
    url: 'https://drive.google.com/drive/folders/1ixc-example',
    fileCount: 18,
    category: 'IXC',
  },
  {
    ...
    url: 'https://drive.google.com/drive/folders/1hubsoft11-example',
    fileCount: 12,
  ...
  },
  {
    ...
    url: 'https://drive.google.com/drive/folders/1voalle-example',
    fileCount: 10,
    category: 'Voalle',
  },
  {
    ...
    url: 'https://drive.google.com/drive/folders/1mksolutions-example',
    fileCount: 11,
